...
module OpenapiClient
  class User
    ...
    attr_accessor :profile_image_path
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'profile_image_path')
        self.profile_image_path = attributes[:'profile_image_path']
      end
      ...
      if attributes.key?(:'account_non_locked')
        self.account_non_locked = attributes[:'account_non_locked']
      end

      if attributes.key?(:'account_non_expired')
        self.account_non_expired = attributes[:'account_non_expired']
      end
    ...
    def valid?
      ...
      role_validator = EnumAttributeValidator.new('String', ["BUSINESSEXPERT", "ADMIN", "CONSULTANT"])
    ...
    def role=(role)
      validator = EnumAttributeValidator.new('String', ["BUSINESSEXPERT", "ADMIN", "CONSULTANT"])
